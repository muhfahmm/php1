    ...
    <form action="" method="post">
        <div class="login-container">
            <div class="login-wrapper shadow">
                ...
                <div class="login-input">
                    <input type="password" name="password1" placeholder="password 1" autocomplete="off" required>
                </div>
                <div class="login-input">
                    <input type="password" name="password2" placeholder="password 2" autocomplete="off" required>
                </div>
                <div class="login-btn">
